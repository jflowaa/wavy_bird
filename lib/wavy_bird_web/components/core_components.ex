defmodule WavyBirdWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WavyBirdWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WavyBirdWeb.Gettext, "errors", msg, opts)
    end
  end
